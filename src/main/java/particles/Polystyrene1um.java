...
public class Polystyrene1um extends Particle
{
    ...
    public final static double permittivity = 2.5;       // Relative permittivity of the particle
    public final static double conductivity = 4.6 * Math.pow(10, -3);       // Conductivity of the particle
     ...
     */
    public Polystyrene1um(double x, double y, double z)
    {
     ...
     */
    public Polystyrene1um(Vector pos)
    {
